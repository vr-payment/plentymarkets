...
class VRPaymentSdkService
{
    ...
    public function call(string $method, array $parameters)
    {
        ...
        $parameters['apiUserId'] = $this->config->get('vRPayment.api_user_id');
        $parameters['apiUserKey'] = $this->config->get('vRPayment.api_user_key');
        if (!isset($parameters['spaceId']) || $parameters['spaceId'] == 0) {
            $parameters['spaceId'] = $this->config->get('vRPayment.space_id');
        }
