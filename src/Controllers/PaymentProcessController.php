...
class PaymentProcessController extends Controller
{
    ...
    private function redirectToCheckout(?Order $order = null, ?int $transactionId = null)
    {
        ...
        $sessionLang = $this->frontendSession->getPlugin()->getValue('vRPaymentOriginLang');
        ...
        if ($originUrl) {
            if ($orderId && $transactionId) {
                ...
                $url = sprintf('%s%s/checkout?vRPayment_failed=1', rtrim($originUrl, '/'), $langPrefix);
            }
    ...
    /**
     * Returns the failure message for a VRPayment transaction — PWA equivalent of the CERES
     ...
     *
     * @param int $id VRPayment transaction ID
     * @return Response
     */
