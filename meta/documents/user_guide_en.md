# Connect to your Payment Service Provider via VR Payment
 
With the VR Payment payment hub you are able to connect to a big selection of payment processors and payment
...
processing payments.  VR Payment is PCI certified. The connectivity allows you to process payments via credit cards as well as 
any other form of alternative payments. You can also process invoices, 
VR Payment creates the invoices and you are able to also create your dunning flow and processes. 
An extensive list of all integrated payment processors can be found on our <a href="https://gateway.vr-payment.de/en/processors" target="_blank">payment processor page</a>.
 
Your client will be redirected to the VR Payment payment page at the end of the process. The payment page can be fully styled according your needs.
...
* You do have a VR Payment account. If not you can <a href="https://gateway.vr-payment.de/user/signup" target="_blank">signup</a> for a test account.
...
The plugin will automatically forward the user to the payment page of VR Payment. This page can be styled 
according your needs. In order to style the payment page, documents or email we use TWIG templates. More information can 
be found on the <a href="https://gateway.vr-payment.de/en/doc/document-handling" target="_blank">documentation</a>.
...
2. Select the group function and under the folder "Plugin" you should find an action called "Refund" of the VR Payment payment.
...
the items with VR Payment.


## Further reading

More Information about the features in VR Payment can be found in our extensive <a href="https://gateway.vr-payment.de/en/doc" target="_blank">documentation</a>.
