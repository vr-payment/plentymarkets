# Verbinden Sie Ihren plentymarkets Shop mit VR Payment

VR Payment bietet Ihnen als PSP / E-Commerce hub direkten Zugang zu einer großen Auswahl an Zahlungsverarbeitern und
...
können Sie für die Verarbeitung Ihrer Zahlung aus einem der integrierten <a href="https://gateway.vr-payment.de/en/processors" target="_blank">Verarbeitern</a> auswählen. Damit wird die Verarbeitung via Kreditkarten aber auch jede weitere Form alternativer Zahlungsarten ermöglicht.
...
Für die Zahlungsabwicklung wird der Kunde auf die VR Payment payment page weitergeleitet, welche Sie vollständig selber gestalten können. 
 
Neben der Zahlungsverarbeitung löst Ihnen VR Payment auch noch zahlreiche weitere Probleme die Sie als Händler haben. Wie beispielsweise:
...
Damit Sie VR Payment nutzen können müssen Sie folgende Voraussetzungen erfüllen:

* Sie benötigen ein VR Payment Konto. Dieses können Sie mit dem <a href="https://gateway.vr-payment.de/user/signup" target="_blank">signup</a> Link kostenfrei erstellen.
...
Für die Verarbeitung der Zahlung werden Sie auf die Zahlungsseite von VR Payment weitergeleitet. Diese Seite können Sie mit Hilfe der TWIG Templates komplett selber gestalten. Mehr Informationen finden Sie in der <a href="https://gateway.vr-payment.de/de-ch/doc/document-handling" target="_blank">Dokumentation</a>.
 
 
### Gutschriften
 
Tragen Sie noch die Stati für die Gutschriften ein, bei welchem automatisch eine Gutschriftsanzeige an VR Payment übermittelt wird. 
...
Status und die Aktion "Rückzahlung der VR Payment-Zahlung", welche Sie im Ordner Plugin finden. 
...
dass die Bestellung mit VR Payment synchronisiert wird. 

## Weitere Informationen

Für mehr Informationen verweisen wir Sie auf unsere extensive <a href="https://gateway.vr-payment.de/de-ch/doc" target="_blank">Dokumentation</a>.
